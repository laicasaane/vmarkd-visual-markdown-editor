...
// VMDE compile-only stub: replaces the embedded MathJax/polyfill blobs (the original
...
// d2latex.Render — which is ONLY on the layout/measure path. VMDE's compile path
