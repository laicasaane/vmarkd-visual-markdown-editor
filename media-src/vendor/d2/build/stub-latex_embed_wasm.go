...
// Visual Markdown Editor compile-only stub: replaces the embedded MathJax/polyfill blobs (the original
...
// d2latex.Render — which is ONLY on the layout/measure path. Visual Markdown Editor's compile path
