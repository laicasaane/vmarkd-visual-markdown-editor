...
//
// VMDE is THE editor for .md, so a user lands here on a conflicted file by accident rather than
...
export const GIT_CONFLICT_MESSAGE =
  'This file has unresolved merge conflicts. VMDE opened it in the plain text editor — ' +
  'editing it here would rewrite the conflict markers and git would stop recognizing them.'

export const GIT_CONFLICT_OVERRIDE = 'Open in VMDE anyway'
