...
// VMDE custom themes (not from ECharts' gallery). `vintage-dark` is our dark adaptation of
...
// Resolve a named ECharts theme (a custom VMDE theme or a vendored gallery theme) to a spec,
